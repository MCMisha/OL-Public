...
public class AdminAboutSectionService : IAdminAboutSectionService
{
    private IAdminAboutSectionRepository _repository;

    public AdminAboutSectionService(IAdminAboutSectionRepository repository)
    {
