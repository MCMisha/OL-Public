...
[Route("[controller]")]
[Authorize]
public class AdminAboutSectionController : ControllerBase
{
    private readonly IAdminAboutSectionService _service;

    public AdminAboutSectionController(IAdminAboutSectionService service)
    {
        _service = service;
    }
